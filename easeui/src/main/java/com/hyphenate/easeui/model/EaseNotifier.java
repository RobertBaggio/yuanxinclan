...
public class EaseNotifier {
    ...
    public synchronized void onNewMsg(EMMessage message) {
        ...
        //在这里加过滤免打扰的消息
        EaseNotificationInfoProvider notificationInfoProvider = EaseUI.getInstance().getNotifier().getNotificationInfoProvider();
        if (notificationInfoProvider != null) {
            ...
            boolean contains = notificationInfoProvider.getNoNotificationIds().contains(chatUsename);
            if (contains) {
                //设置了免打扰就不要去震动了
                return;
            }
...
//            mBuilder.setFullScreenIntent(pendingIntent, true);
    ...
    /**
     * get notification info Provider
     */
    public EaseNotificationInfoProvider getNotificationInfoProvider() {
    ...
    public interface EaseNotificationInfoProvider {
         ...
         * @return
         */
        List<String> getNoNotificationIds();
    }
}
