...
//            Log.v("Lgq","ger======EaseChatRow====setUpBaseView== "+userAvatarView);//聊天头像
            if (message.direct() == Direct.SEND) {
//                EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);

                EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView,mimage,mphone);
            } else {
                EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView,mimage,mphone);
