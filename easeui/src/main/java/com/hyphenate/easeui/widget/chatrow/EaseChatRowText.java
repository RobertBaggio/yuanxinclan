...
//            bubble.setBackgroundResource(R.drawable.ease_receive_picture);
        }else{
...
//             message = EMMessage.createSendMessage(EMMessage.Type.CMD);cardUserName  cardUserPhone cardEpNm cardAddress cardPosition
        message.getStringAttribute("cardUserName",null);
        message.getStringAttribute("cardUserPhone",null);
        message.getStringAttribute("cardEpNm",null);
        message.getStringAttribute("cardAddress",null);
        message.getStringAttribute("cardPosition",null);//聊天信息
//        Log.v("Lgq","msgtype======"+message.getType()+"...."+((EMTextMessageBody) message.getBody()).getMessage()+"......"+message.getStringAttribute("cardUserName",null));
