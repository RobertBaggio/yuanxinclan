...
import static com.hyphenate.easeui.R.id.header;
...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.headerView = (TextView) convertView.findViewById(header);
        ...
        String userAvator = user.getAvatar();
        ...
        EaseUserUtils.setUserNick(TextUtils.isEmpty(userNick)? username : userNick, holder.nameView);
        EaseUserUtils.setUserAvatar(getContext(), TextUtils.isEmpty(userAvator) ? username : userAvator, holder.avatar,mimage,mphone);
