...
public class EaseBaiduMapActivity extends EaseBaseActivity {
	...
	public Boolean isDaohang = false;
...
//		sendButton.setVisibility(View.GONE);
		sendButton.setText("导航");
		sendButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Logger.logE("hxw", "adsfasdf");
				showMapDialog("起点", address, lastLocation.getLatitude(), lastLocation.getLongitude(), latitude, longtitude );
			}
		});
	...
	public void showMapDialog(final String startName, final String endName, final double originlat, final double originlon, final double deslat, final double deslon) {
		final Dialog dialog;
		LayoutInflater inflater = LayoutInflater.from(EaseBaiduMapActivity.this);
		...
		dialog = new Dialog(EaseBaiduMapActivity.this);
...
//        lp.alpha = 0.7f; // 透明度
		...
		List<String> installedMapList = AmapUtil.isAvilibleList(EaseBaiduMapActivity.this);
		if (installedMapList.size() == 0) {
			Toast.makeText(EaseBaiduMapActivity.this, "请安装导航地图软件", Toast.LENGTH_LONG).show();
			return;
		}
		...
		baiduLayout.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				AmapUtil.goToBaiduNaviActivity(EaseBaiduMapActivity.this, originlat, originlon, deslat, deslon, "driving");
				dialog.dismiss();
			}
		});
		gaodeLayout.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				AmapUtil.goToGaodeNaviActivity(EaseBaiduMapActivity.this, "yxbl","", String.valueOf(deslat), String.valueOf(deslon), "0", "0");
				dialog.dismiss();
			}
		});
		tencentLayout.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				AmapUtil.goToTenCentNaviActivity(EaseBaiduMapActivity.this, "drive", startName, originlat, originlon, endName, deslat, deslon);
				dialog.dismiss();
			}
		});
