...
import com.yuanxin.clan.core.adapter.BusinessMemberAdapter;
...
public class BusinessMemberSearchActivity extends BaseActivity{
...
//        mMore_loadDialog = new More_LoadDialog(this);
    ...
    private void initRecyclerView() {
        adapter = new BusinessMemberAdapter(this, mMembers);
        adapter.setOnItemClickListener(new BusinessMemberAdapter.OnItemClickListener() {
            @Override
...
//                startActivity(intent);
        ...
        adapter.setOnCompanyDetailClickListener(new BusinessMemberAdapter.OnCompanyDetailClickListener() {
            @Override
            public void onItemClick(int position) {
                try{
                    Intent intent = new Intent(BusinessMemberSearchActivity.this, CompanyDetailWebActivity.class);//有个聊天的标志
        ...
        adapter.setOnCompanyHistoryListener(new BusinessMemberAdapter.OnCompanyHistoryListener() {
            @Override
            public void onItemClick(int position) {
                //跳转企业历程
                ...
                startActivity(new Intent(BusinessMemberSearchActivity.this, HomeADactivity.class).putExtra("url", url));
            }
        });
        adapter.setOnCompanyVisitListener(new BusinessMemberAdapter.OnCompanyVisitListener() {
            @Override
            public void onItemClick(int position) {
                Intent intent = new Intent(BusinessMemberSearchActivity.this, AppointmentOneActivity.class);
        ...
        fragmnetMyCollectArticleSpringview.setListener(new SpringView.OnFreshListener() {
            ...
            public void onLoadmore() {
                ...
                if (currentPage>pageCount){
                    ToastUtil.showInfo(BusinessMemberSearchActivity.this, "已加载完", Toast.LENGTH_SHORT);
                    return;
                }
                getBusinessMember(currentPage, activi_middle_editextt.getText().toString());
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.selecthyli:
                Intent publishIntent = new Intent(BusinessMemberSearchActivity.this, BusinessDistrictClassifyActviity.class);
...
//        mMore_loadDialog.show();
        ...
        doHttpGet(url, params, new RequestCallback() {
            ...
            public void onFailure(int i, Header[] headers, String s, Throwable throwable) {
                ToastUtil.showWarning(BusinessMemberSearchActivity.this, "网络连接异常", Toast.LENGTH_SHORT);
...
//                mMore_loadDialog.dismiss();
                try {
                    ...
                    if (object.getString("success").equals("true")) {
                        ...
                        ToastUtil.showWarning(BusinessMemberSearchActivity.this, object.getString("msg"), Toast.LENGTH_SHORT);
                    }
