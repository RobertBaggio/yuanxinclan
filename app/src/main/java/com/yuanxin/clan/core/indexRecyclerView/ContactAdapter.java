...
import com.yuanxin.clan.core.activity.ChatListActivity;
...
public class ContactAdapter extends BaseAdapter<ContactModel.MembersEntity, ContactAdapter.ContactViewHolder>
    ...
    public ContactAdapter(Context ct, List<ContactModel.MembersEntity> mLists, int permission) {
        this.mLists = mLists;
        mContext = ct;
...
//                    ((ChatListActivity) mContext).deleteUser(position);
//                }
//            });
        } else {
