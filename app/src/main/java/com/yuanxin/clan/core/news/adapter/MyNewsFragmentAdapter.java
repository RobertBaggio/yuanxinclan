...
import com.yuanxin.clan.core.news.view.FragmentTwoOne;
import com.yuanxin.clan.core.util.MyShareUtil;

import java.util.List;

/**
 * Created by lenovo1 on 2017/1/19.
 */
public class MyNewsFragmentAdapter extends FragmentPagerAdapter {
    ...
    public MyNewsFragmentAdapter(FragmentManager fragmentManager, List<NewsType> titleList) {
    ...
    public Fragment getItem(int position) {
        return FragmentTwoOne.newInstance(titleList.get(position).getNewsTypeId());
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ft.remove(fragment);
        //换成新的fragment
        fragment = FragmentTwoOne.newInstance(titleList.get(position).getNewsTypeId());
