 ...
 */
//我的服务商
public class FragmentMyTeamworkBusinessAll extends BaseFragment {
    ...
    public int getViewLayout() {
        return R.layout.fragment_my_teamwork_business_all;
    }
    ...
    private void getRecyclerView() {
        ...
        adapter.setOnItemLongClickListener(new HeZuoAdapter.OnItemLongClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                showNormalDialogOne("服务商", companyInformationDetailNewEntityList.get(position).getEnshrineId(),position);
            }
        });
    ...
    private void getWebInfo(int pageNumber) {//还差图片
        ...
        params.put("type", 6);//1：新闻 2：商圈 3：企业 4：众筹  5：商品 6: 服务商 7: 供应商  8: 客户
