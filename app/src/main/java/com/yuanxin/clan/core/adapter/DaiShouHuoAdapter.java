...
public class DaiShouHuoAdapter extends RecyclerView.Adapter<DaiShouHuoAdapter.ViewHolder> {
    ...
    public DaiShouHuoAdapter(Context context, List<FragmentMyOrderAllEntity> entities) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        try {
            ...
            if (status.equals("2")){
                ...
                holder.qrshouhuote.setText("申请退款");
...
//            holder.sqtuikte.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    mOnItemClickListenerback.onItemClick(holder.itemView,position);
//                }
//            });
            holder.qrshouhuote.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (entityList.get(position).getOrderStatus().equals("2")){
                        mOnItemClickListenerback.onItemClick(holder.itemView,position);
                        return;
                    }
...
//        TextView itemFragmentMyOrderAllAll;
    ...
    public void setOnItemClickListenerback(OnItemClickListenerback onItemClickListener) {
        this.mOnItemClickListenerback = onItemClickListener;
    }

    private void qrshouhuo(final DaiShouHuoAdapter.ViewHolder holder, String id) {
    ...
    private void showNormalDialogOne(final  DaiShouHuoAdapter.ViewHolder holder, final String id) {
        /* @setIcon 设置对话框图标
         * @setTitle 设置对话框标题
