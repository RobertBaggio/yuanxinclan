 ...
 * Describe:
 * Author: xjc
 * Date: 2017/9/28 0028 20:21
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

public class MyTradesStatusAdapter extends RecyclerView.Adapter<MyTradesStatusAdapter.ViewHolder> {
    ...
    public MyTradesStatusAdapter(Context context, List<TradesEntity> list) {
