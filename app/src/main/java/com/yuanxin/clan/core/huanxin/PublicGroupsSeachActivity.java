                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            if (e.getErrorCode() == EMError.GROUP_INVALID_ID) {
                                ToastUtil.showWarning(getApplicationContext(), getResources().getString(R.string.group_not_existed), Toast.LENGTH_SHORT);
                            } else {
                                ToastUtil.showWarning(getApplicationContext(), getResources().getString(R.string.group_search_failed) + " : " + getString(R.string.connect_failuer_toast), Toast.LENGTH_SHORT);
                            }
                        }
                    });
                }
