 ...
 * Describe:
 * Author: xjc
 * Date: 2017/10/26 0026 18:16
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

public class XuQiuFragment extends BaseFragment implements PullToRefreshView.OnFooterRefreshListener,PullToRefreshView.OnHeaderRefreshListener{
    ...
    private void initRecyclerView() {
        ...
        sosli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getActivity(), GongxuSOS_Activity.class).putExtra("supplyDemand", 1));
            }
        });
    }
