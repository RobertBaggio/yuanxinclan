...
public class PresentCustomMadeIntroduceActivity extends BaseActivity {
    ...
    public int getViewLayout() {
        return R.layout.activity_present_custom_made_introduce;
    }
    ...
    private void getInfo() {
        ...
        if (TextUtil.isEmpty(introduce)) {
            activityThinkTankIntroduceIntroduceEdit.setText(null);
        } else {
            activityThinkTankIntroduceIntroduceEdit.setText(introduce);
        }
    }
