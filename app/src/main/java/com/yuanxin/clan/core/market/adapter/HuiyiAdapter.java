 ...
 * Describe:
 * Author: xjc
 * Date: 2017/9/15 0015 18:38
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

//public class HuiyiAdapter {
//}
public class HuiyiAdapter extends RecyclerView.Adapter<HuiyiAdapter.ViewHolder> {

    private List<HuiyiBean> entityList;
    private Context context;
    private OnItemClickListener mOnItemClickListener;

    public HuiyiAdapter(Context context, List<HuiyiBean> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_huiyizl, null);
