...
public class My_BusMemberActivity extends BaseActivity {
...
//    LinearLayout activityTYuanXinCrowdRightImageLayout;
    ...
    public void initModule() {
        ...
        activityYuanXinCrowdMiddleText.setText("商会成员");
        ...
        activityBaseWebAddWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.startsWith(Url.urlHost + "/weixin/getJsp?url=wechatweb/epdetail")) {
                    startActivity(new Intent(My_BusMemberActivity.this, BusCompanyDativity.class).putExtra("url", url));
...
//            window.yxbl_app.toCompanyDetail()  //js调用android源码方法
                ...
                Utils.gotoCompanyDetail(My_BusMemberActivity.this, Integer.parseInt(epId), accessPath);
            }

            @JavascriptInterface
            public void searchMember(String businessAreaId) {
                //搜索商圈成员
                Intent intent = new Intent(My_BusMemberActivity.this, BusinessMemberSearchActivity.class);
                intent.putExtra("businessAreaId", Integer.parseInt(businessAreaId));
                startActivity(intent);
            }
            @JavascriptInterface
            public void searchMember(String businessAreaId,String name) {
                //搜索商圈成员
                Intent intent = new Intent(My_BusMemberActivity.this, BusinessMemberSearchActivity.class);
                intent.putExtra("businessAreaId", Integer.parseInt(businessAreaId));
            ...
            public void BusinessVisit(String aid,String aname,String ac,String ap) {
                // 测试商圈成员搜索，发布版本放开
                Intent intent = new Intent(My_BusMemberActivity.this, AppointmentOneActivity.class);
            ...
            public void onSuccess(int i, Header[] headers, String s) {
                try {
                    ...
                    if (object.getString("success").equals("true")) {
                        Intent intent = new Intent(My_BusMemberActivity.this, PersionChatActivity.class);
