...
public class VollyHelperNew {
    ...
    public RequestQueue sendRequestPost(String url,
        ...
        return sendRequest(url, map, handler, what, Request.Method.POST);
    }

    public RequestQueue sendRequestGet(String url, final Handler handler,
                                       final int what) {
        return sendRequest(url, null, handler, what, Request.Method.GET);
    }
    ...
    public RequestQueue sendRequestPostWithCallbackAndInfo(String url,
                                                           ...
                                                           String infoFailure) {
        return sendRequestWithCallbackAndInfo(url, Request.Method.POST, map,
    ...
    public RequestQueue sendRequestGetWithCallbackAndInfo(String url,
        ...
        return sendRequestWithCallbackAndInfo(url, Request.Method.GET, null,
                infoSuccess, infoFailure);
    }
    ...
    public RequestQueue sendRequestGetWithCallback(String url,
        ...
        String params = convertMapToGetParams(map);
        url += params;
        return sendRequestWithCallback(url, Request.Method.GET, null, responseCallBack,
                null, null);
    }
    ...
    public RequestQueue sendRequestPostWithCallback(String url,
        ...
        return sendRequestWithCallback(url, Request.Method.POST, map, responseCallBack,
                null, null);
    }
    ...
    public RequestQueue sendRequestWithCallback(String url, int method,
        ...
        JSONObject jo = null;
        if (method != Request.Method.GET && method != Request.Method.DELETE && map != null) {
            jo = new JSONObject(map);
        }
        if (jsonObject != null) {
            jo = jsonObject;
...
//            }
    ...
    public RequestQueue sendRequestPostOfJSON(String url, JSONObject object,
        ...
        JsonObjectRequest json = new JsonObjectRequest(Request.Method.POST, url,
