...
public class MiniTradesShowActivity extends BaseActivity implements PullToRefreshView.OnFooterRefreshListener,PullToRefreshView.OnHeaderRefreshListener{
    ...
    private void initRecyclerView() {
        mMyTradesStatusAdapter = new NeardtradesAdapter(MiniTradesShowActivity.this, mEntities);
        mMyTradesStatusAdapter.setOnItemClickListener(new NeardtradesAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(MiniTradesShowActivity.this, TradesDetailActivity.class);
