 ...
 * Author: lgq
 * Date: 2018/4/4 0004 16:57
 */

public class ActivityGroupsDetail extends BaseActivity {
    ...
    private String gid,gname,gimage;

    @Override
    public int getViewLayout() {
        return R.layout.groupsdetailla;
    }
    ...
    protected void initView(Bundle savedInstanceState, Intent intent) {
        ...
        mTitle.setText(Utils.isEmpty(getIntent().getStringExtra("title"))?"活动详情":getIntent().getStringExtra("title"));
        gid = getIntent().getStringExtra("gid");
        gname = getIntent().getStringExtra("gname");
        gimage = getIntent().getStringExtra("gimage");
        String   url= Url.urlWeb+"/act-detail&appFlg=1"+"&activityId="+id+"&userId="+UserNative.getId();

//        www.yxtribe.com/yuanxinbuluo/weixin/getJsp?url=wechatweb/epMallInfo&commodityId=1362&appFlg=1
 //         http://192.168.1.200:8080/yuanxinbuluo/weixin/getJsp?url=wechatweb/activity-detail&appFlg=1&activityId=7&userId=1314
//        http://www.yxtribe.com/yuanxinbuluo/weixin/getJsp?url=wechatweb/act-detail&appFlg=0&activityId=24&userId=124
    ...
    private void initWebView() {
        ...
        mWebview.addJavascriptInterface(new WebViewJavaScriptFunction() {
            ...
            public void toChat(String toChatUsername) {
                ...
                Intent intent = new Intent(ActivityGroupsDetail.this, PersionChatActivity.class);
            ...
            public void goToBusinessChatRoom() {
                Intent intent = new Intent(ActivityGroupsDetail.this, PersionChatActivity.class);
                intent.putExtra(Constant.EXTRA_USER_ID, gid);//群聊id
                ...
                intent.putExtra("toNick", gname);
                intent.putExtra("toImage", gimage);
                MyShareUtil.sharedPint("bid",0);
                MyShareUtil.sharedPstring("bp","");
                MyShareUtil.sharedPstring("bn",gname);
                startActivity(intent);
            }
            @JavascriptInterface
            ...
            public void onEdit() {
                if (mGongXuEntity.getSupplyDemand().equals("0")){
                    Intent intent = new Intent(ActivityGroupsDetail.this, OutputGongyActivity.class);
                    intent.putExtra("datas", (Serializable) mGongXuEntity);
                    intent.putExtra("type", "my");
                    startActivity(intent);
                    finish();
                }else {
                    Intent intent = new Intent(ActivityGroupsDetail.this, OutputXuQiuActivity.class);
                    intent.putExtra("datas", (Serializable) mGongXuEntity);
                    intent.putExtra("type", "my");
                    startActivity(intent);
                    finish();
...
//            window.yxbl_app.lookShoppingCar()  //js调用android源码方法,查看购物车
                startActivity(new Intent(ActivityGroupsDetail.this, ShoppingCartActivity.class));
            }
...
//            window.yxbl_app.addGoodToCar()  //js调用android源码方法,加入购物车
            ...
            @JavascriptInterface
            public void toLogin() {
                startActivity(new Intent(ActivityGroupsDetail.this, LoginActivity.class));
            }
...
//                        startActivity(new Intent(ExternalWebActivity.this, ShoppingCartActivity.class));
                        ...
                        Intent intent = new Intent(ActivityGroupsDetail.this, BuyOrderActivityWeb.class);
