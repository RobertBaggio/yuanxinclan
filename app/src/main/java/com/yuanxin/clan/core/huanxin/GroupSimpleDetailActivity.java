...
public class GroupSimpleDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (groupInfo != null) {
            ...
            group = PublicGroupsSeachActivity.searchedGroup;//公开群搜索
            if (group == null)
                return;
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            ToastUtil.showError(GroupSimpleDetailActivity.this, st1 + e.getMessage(), Toast.LENGTH_LONG);
                        }
                    });
                }
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            if (group.isMembersOnly())
                                ToastUtil.showInfo(GroupSimpleDetailActivity.this, st3, Toast.LENGTH_SHORT);
                            else
                                ToastUtil.showInfo(GroupSimpleDetailActivity.this, st4, Toast.LENGTH_SHORT);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            ToastUtil.showError(GroupSimpleDetailActivity.this, st5 + e.getMessage(), Toast.LENGTH_SHORT);
                        }
                    });
                }
            }
