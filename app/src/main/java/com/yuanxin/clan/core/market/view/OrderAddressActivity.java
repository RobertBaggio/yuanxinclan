...
import com.yuanxin.clan.core.market.adapter.OrderAddressAdapter;
...
public class OrderAddressActivity extends BaseActivity {
    ...
    private void initRecyclerView() {
        //搜索结果
        adapter = new OrderAddressAdapter(OrderAddressActivity.this, goodsAddressEntities, OrderAddressActivity.this);
