...
import com.yuanxin.clan.core.adapter.MeToAppointmentAdapter;
 ...
 * Describe:
 * Author: xjc
 * Date: 2017/9/21 0021 17:45
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

public class MeToAppointmentFragment extends BaseFragment {
    ...
    private int maxpage;
    private MeToAppointmentAdapter adapter;
    ...
    private void initRecyclerView() {
        adapter = new MeToAppointmentAdapter(getContext(), businessDistrictListEntities);
        adapter.setOnItemClickListener(new MeToAppointmentAdapter.OnItemClickListener() {
            @Override
...
//        getMyBusinessDistrict(1);
                ...
                try {
                    ...
                    if (object.getString("success").equals("true")) {
                        ...
                        for (int a = 0; a < jsonArray.length(); a++) {
                            ...
                            String bVisitorNm = businessObject.getString("bVisitorNm");
                            ...
                            String bVisitorPhone = businessObject.getString("bVisitorPhone");
                            ...
                            String aVisitorRead = businessObject.getString("aVisitorRead");
                            ...
                            entity.setaVisitorRead(aVisitorRead);
    ...
    private void getMyBusinessUD(int pageNumber,final int positio) {
        String url = Url.myappointYUEDU;
        RequestParams params = new RequestParams();
        params.put("visitAppointmentId", pageNumber);//用户id
        params.put("aVisitorRead", 1);
        ...
        doHttpPost(url, params, new RequestCallback() {
            ...
            public void onSuccess(int i, Header[] headers, String s) {
                ...
                a = businessDistrictListEntities.get(positio);
                intent.putExtra("datas", (Serializable) a);
                intent.putExtra("tome","0");
