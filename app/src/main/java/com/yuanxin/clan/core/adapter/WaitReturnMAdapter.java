 ...
 * Describe:
 * Author: xjc
 * Date: 2017/7/29 0029 11:02
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

//public class WaitReturnMAdapter {
//}
public class WaitReturnMAdapter extends RecyclerView.Adapter<WaitReturnMAdapter.ViewHolder> {
    private Context context;
    private OnItemClickListener mOnItemClickListener;
    private OnItemClickListeneragree mOnItemClickListeneragree;
...
//    private ArrayList<String> datas = new ArrayList<>();
    ...
    public WaitReturnMAdapter(Context context, List<FragmentMyOrderAllEntity> entities) {
...
//    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.waitreturnmoney, null);
...
//        int all=numberOne*priceOne;
            ...
            holder.itemFragmentMyOrderAllState.setText(entity.getState());//待付款
            holder.ddwliucontentnamestuta.setText(entity.getState());
...
//        holder.itemFragmentMyOrderAllRecyclerView.setAdapter(adapter);
        ...
        if (mOnItemClickListener != null) {
            ...
            holder.ddagreereturnmoneyte.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mOnItemClickListeneragree.onItemClick(v,position);
                }
            });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView ddnumte;
        @BindView(R.id.ddagreereturnmoneyte)
        TextView ddagreereturnmoneyte;
...
//        TextView itemFragmentMyOrderAllAll;
    ...
    public interface OnItemClickListeneragree {
        void onItemClick(View view, int position);
    }

    public void setOnItemClickListeneragree(OnItemClickListeneragree onItemClickListener) {
        this.mOnItemClickListeneragree = onItemClickListener;
    }
