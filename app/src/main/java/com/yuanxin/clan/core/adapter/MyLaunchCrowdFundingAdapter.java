...
import com.yuanxin.clan.core.entity.MyLaunchCrowdFundingEntity;
 ...
 */
public class MyLaunchCrowdFundingAdapter extends RecyclerView.Adapter<MyLaunchCrowdFundingAdapter.ViewHolder> {
    private List<MyLaunchCrowdFundingEntity> entityList;
    private Context context;
    private OnItemClickListener mOnItemClickListener;

    public MyLaunchCrowdFundingAdapter(Context context, List<MyLaunchCrowdFundingEntity> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_my_all_crowd_funding, null);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        MyLaunchCrowdFundingEntity entity = entityList.get(position);
