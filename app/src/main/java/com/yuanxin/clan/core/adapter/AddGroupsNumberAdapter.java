 ...
 */
public class AddGroupsNumberAdapter extends RecyclerView.Adapter<AddGroupsNumberAdapter.ViewHolder> {
    ...
    public AddGroupsNumberAdapter(Context context, List<FriendListEntity> list, String groupId, GroupChatDetailActivity activity) {
