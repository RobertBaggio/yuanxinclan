...
public class LipingkuActivity extends BaseActivity implements PullToRefreshView.OnFooterRefreshListener,PullToRefreshView.OnHeaderRefreshListener{
    ...
    public int getViewLayout() {
        return R.layout.lipingkulayout;
    }
...
//        getBusinesslist(1);
    ...
    private void initRecyclerView() {
        mMyTradesStatusAdapter = new NeardtradesAdapter(LipingkuActivity.this, mEntities);
        mMyTradesStatusAdapter.setOnItemClickListener(new NeardtradesAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(LipingkuActivity.this, TradesDetailActivity.class);
    ...
    private void getBusinesslist(int id) {
        ...
        if (type.equals("n")){
            ...
            params.put("year", MyShareUtil.getSharedString("2017"));
        }
