...
public class MyserviceDetailWebActivity extends BaseActivity{
    ...
    public int getViewLayout() {
        return R.layout.myserverdetailwb;
    }
...
//            window.yxbl_app.scanCode()  //js调用android源码方法,二维码扫描
            ...
            * */
            ...
            public void gotoInvestment(String id) {
                startActivity(new Intent(MyserviceDetailWebActivity.this, XmtouzActivity.class).putExtra("businessAreaId",id));
