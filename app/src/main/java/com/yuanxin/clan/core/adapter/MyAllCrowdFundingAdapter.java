...
import com.yuanxin.clan.core.entity.MyAllCrowdFundingEntity;
 ...
 */
public class MyAllCrowdFundingAdapter extends RecyclerView.Adapter<MyAllCrowdFundingAdapter.ViewHolder> {
    private List<MyAllCrowdFundingEntity> entityList;
    private Context context;
    private OnItemClickListener mOnItemClickListener;

    public MyAllCrowdFundingAdapter(Context context, List<MyAllCrowdFundingEntity> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        MyAllCrowdFundingEntity entity = entityList.get(position);
