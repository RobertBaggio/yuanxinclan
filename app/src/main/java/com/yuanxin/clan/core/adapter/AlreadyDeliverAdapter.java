 ...
 * Describe:
 * Author: xjc
 * Date: 2017/7/29 0029 10:24
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

//public class AlreadyDeliverAdapter {
//}
public class AlreadyDeliverAdapter extends RecyclerView.Adapter<AlreadyDeliverAdapter.ViewHolder> {
...
//    private ArrayList<String> datas = new ArrayList<>();
    ...
    public AlreadyDeliverAdapter(Context context, List<FragmentMyOrderAllEntity> entities) {
...
//    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.alreadydeliveradapter, null);
...
//        int all=numberOne*priceOne;
            ...
            holder.itemFragmentMyOrderAllState.setText("已发货");//待付款
