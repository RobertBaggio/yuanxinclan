...
public class ServiceSearchActivity extends BaseActivity{
    ...
    protected void initView(Bundle savedInstanceState, final Intent intent) {
        mMy_loadingDialog = My_LoadingDialog.getInstance(ServiceSearchActivity.this);
        mAdapter = new CommdssAdapter(ServiceSearchActivity.this,mCommodityEntityList);
        mAdapter.setOnItemClickListener(new CommdssAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent1 = new Intent(ServiceSearchActivity.this, My_ServiceInfoActivity.class);
...
//                        mMy_loadingDialog.show();
    ...
    //恢复/industrylist
    private void getWebInfo(String name, int pageNumber) {
        String url = Url.searchService;
...
//                    Log.v("lgq",".....企业库。。数据。。test==="+s);
                    if (object.getString("success").equals("true")) {
                        ...
                        if (dataArray.length()==0){
                            ...
                            kongli.setVisibility(View.GONE);
                        }
