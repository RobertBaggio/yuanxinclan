 ...
 * Describe:
 * Author: xjc
 * Date: 2017/10/31 0031 15:21
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

public class YuanTuImageView extends ImageView {
    ...
    public YuanTuImageView(Context context) {
        super(context);
        init(context, null);
    }

    public YuanTuImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public YuanTuImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mRadius = array.getDimensionPixelSize(R.styleable.MLImageView_radiuss, mRadius);
            mShapeType = array.getInteger(R.styleable.MLImageView_shape_type, mShapeType);
            mBorderWidth = array.getDimensionPixelOffset(R.styleable.MLImageView_border_widthh, mBorderWidth);
            mBorderColor = array.getColor(R.styleable.MLImageView_border_colorr, mBorderColor);
            array.recycle();
        }
