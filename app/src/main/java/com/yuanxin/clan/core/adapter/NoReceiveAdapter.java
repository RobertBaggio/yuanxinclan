 ...
 * Describe:
 * Author: xjc
 * Date: 2017/7/28 0028 21:31
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

//public class NoReceiveAdapter {
//}
public class NoReceiveAdapter extends RecyclerView.Adapter<NoReceiveAdapter.ViewHolder> {
...
//    private ArrayList<String> datas = new ArrayList<>();
    ...
    public NoReceiveAdapter(Context context, List<FragmentMyOrderAllEntity> entities) {
...
//    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.noreceivelayout, null);
...
//        holder.itemFragmentMyOrderAllRecyclerView.setAdapter(adapter);
            ...
            holder.ddwliuli.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (ifshowwl){
                        ...
                        holder.ddwliuxxcommitte.setVisibility(View.VISIBLE);
                    }else {
                        holder.ddwliucontentli.setVisibility(View.GONE);
                        holder.ddwliuxxcommitte.setVisibility(View.GONE);
                    }
                    ifshowwl=!ifshowwl;
                }
            });
            holder.ddwliuxxcommitte.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String name = holder.ddwliucontentname.getText().toString();
                    String code =holder.ddwliucontentcode.getText().toString();
                    mOnItemClickListenercommit.onItemClick(v,position,name,code);
                }
            });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView ddwliuline;
        @BindView(R.id.ddwliuxxcommitte)
        TextView ddwliuxxcommitte;
...
//        TextView itemFragmentMyOrderAllAll;
    ...
    public interface OnItemClickListenercommit {
        void onItemClick(View view, int position,String name,String code);
    }

    public void setOnItemClickListener(OnItemClickListener onItemClickListener) {
        this.mOnItemClickListener = onItemClickListener;
    }
    public void setOnItemClickListenercommit(OnItemClickListenercommit onItemClickListener) {
        this.mOnItemClickListenercommit = onItemClickListener;
    }
