 ...
 */
//我的客户
public class FragmentMyTeamworkBusinessNeed extends BaseFragment {
    ...
    public int getViewLayout() {
        return R.layout.fragment_my_teamwork_business_need;
    }
    ...
    private void initRecyclerView() {
        ...
        adapter.setOnItemClickListener(new HeZuoAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Log.v("Lgq","..."+companyInformationDetailNewEntityList.get(position).getEnterprise().getEpId()+"..."+companyInformationDetailNewEntityList.get(position).getEnterprise().getEpLinktel());
        ...
        adapter.setOnItemLongClickListener(new HeZuoAdapter.OnItemLongClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                showNormalDialogOne("客户", companyInformationDetailNewEntityList.get(position).getEnshrineId(),position);
            }
        });
...
//        params.put("keyId", 0);//收藏项目ID
        ...
        params.put("type", 8);//1：新闻 2：商圈 3：企业 4：众筹  5：商品 6: 服务商 7: 供应商  8: 客户
