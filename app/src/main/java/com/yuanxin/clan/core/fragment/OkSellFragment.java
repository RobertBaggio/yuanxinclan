 ...
 * Describe:
 * Author: xjc
 * Date: 2017/7/28 0028 10:33
 * Copyright (c) 2017, tonixtech.com All Rights Reserved.
 */

//public class OkSellFragment {
//}
...
import com.yuanxin.clan.core.adapter.SellAdapter;
 ...
 * 已完成
 */
public class OkSellFragment extends BaseFragment {
    ...
    private SellAdapter adapter;//CompanyInformationDetailChooseAdapter
    ...
    private void initRecyclerView() {
        adapter = new SellAdapter(getContext(), allEntities);
    ...
    private void getGankInto(int page) {
        ...
        params.put("orderStatus", "4,7");//企业id
