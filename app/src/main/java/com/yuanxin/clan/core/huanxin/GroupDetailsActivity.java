...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
    ...
    private EMPushConfigs pushConfigs;//jar包里面的
    private String mimage,mphone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mimage = sp.getString("userImage", null);
        mphone = sp.getString("userPhone", null);
                                ...
                                try {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            ...
                                            ToastUtil.showSuccess(getApplicationContext(), st6, Toast.LENGTH_SHORT);
                                        }
                                    });
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            progressDialog.dismiss();
                                            ToastUtil.showError(getApplicationContext(), st7, Toast.LENGTH_SHORT);
                                        }
                                    });
                                }
                            }
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            refreshMembers();
                            pd.dismiss();
                            ToastUtil.showSuccess(getApplicationContext(), getString(R.string.Move_into_blacklist_success), Toast.LENGTH_SHORT);
                        }
                    });
                } catch (HyphenateException e) {
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            ToastUtil.showError(getApplicationContext(), getString(R.string.failed_to_move_into), Toast.LENGTH_SHORT);
                        }
                    });
                }
            }
    ...
    private void clearGroupHistory() {
        ...
        ToastUtil.showSuccess(this, getString(R.string.messages_are_empty), Toast.LENGTH_SHORT);
    }
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            setResult(RESULT_OK);
                            finish();
                            if (PersionChatActivity.activityInstance != null)
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            ToastUtil.showError(getApplicationContext(), getResources().getString(R.string.Exit_the_group_chat_failure) + " " + e.getMessage(), Toast.LENGTH_LONG);
                        }
                    });
                }
            }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            ToastUtil.showError(getApplicationContext(), st5 + e.getMessage(), Toast.LENGTH_LONG);
                        }
                    });
                }
            }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            ToastUtil.showError(getApplicationContext(), st6 + e.getMessage(), Toast.LENGTH_LONG);
                        }
                    });
                }
            }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            progressDialog.dismiss();
                            ToastUtil.showError(GroupDetailsActivity.this, "progress failed", Toast.LENGTH_SHORT);
                        }
                    });
                }
            }
...
//				button.setCompoundDrawables(null, avatar, null, null);
                ...
                EaseUserUtils.setUserAvatar(getContext(), username, holder.imageView,mimage,mphone);
                if (isInDeleteMode) {
                    // 如果是删除模式下，显示减人图标
                    ...
                    public void onClick(View v) {
                        if (isInDeleteMode) {
                            ...
                            if (!NetUtils.hasNetwork(getApplicationContext())) {
                                ToastUtil.showWarning(getApplicationContext(), getString(R.string.network_unavailable), Toast.LENGTH_SHORT);
                                return;
                            }
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            ToastUtil.showError(getApplicationContext(), st14 + e.getMessage(), Toast.LENGTH_LONG);
                                        }
                                    });
                                }
