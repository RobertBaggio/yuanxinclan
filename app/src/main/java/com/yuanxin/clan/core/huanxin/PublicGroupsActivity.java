...
public class PublicGroupsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb = (ProgressBar) findViewById(R.id.em_activity_public_groups_progressBar);
        listView = (ListView) findViewById(R.id.em_activity_public_groups_list);
        ...
        footLoadingLayout = (LinearLayout) footView.findViewById(R.id.em_listview_footer_view_loading_layout);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(PublicGroupsActivity.this, GroupSimpleDetailActivity.class).
                        putExtra("groupinfo", adapter.getItem(position)));//群聊资料
            }
        });
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            pb.setVisibility(View.INVISIBLE);
                            footLoadingLayout.setVisibility(View.GONE);
                            ToastUtil.showError(PublicGroupsActivity.this, "load failed, please check your network or try it later", Toast.LENGTH_SHORT);
                        }
                    });
                }
            }
    ...
    private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ((TextView) convertView.findViewById(R.id.em_row_group_name)).setText(getItem(position).getGroupName());
