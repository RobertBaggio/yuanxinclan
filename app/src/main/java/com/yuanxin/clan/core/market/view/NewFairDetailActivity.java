...
public class NewFairDetailActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState, Intent intent) {
        initWebView();
        int marketId = getIntent().getIntExtra("marketId",1);
//        http://10.198.5.162:8080/yuanxinbuluo/weixin/getJsp?url=wechatweb/market&marketId=79
        String url = Url.urlWeb + "/market&marketId=" + marketId +"&appFlg=1";
...
//            window.yxbl_app.toChat()  //js调用android源码方法,发起环信聊天
                ...
                Intent intent = new Intent(NewFairDetailActivity.this, PersionChatActivity.class);
...
//            window.yxbl_app.lookShoppingCar()  //js调用android源码方法,查看购物车
                startActivity(new Intent(NewFairDetailActivity.this, ShoppingCartActivity.class));
            }
...
//            window.yxbl_app.scanCode()  //js调用android源码方法,二维码扫描
    ...
    private void addGoodsToCar(CommdoityDetail mCommdoityDetail, int shopDataFrom) {
        ...
        //设置选择的颜色
        params.put("commodityColor", String.valueOf(mCommdoityDetail.getCommodityColor()));//颜色
        //设置选择的规格
        params.put("commoditySp", String.valueOf(mCommdoityDetail.getCommoditySp()));//商品规格
        params.put("commodityNumber", Integer.valueOf(mCommdoityDetail.getCommodityQuantity()));//商品数量
        params.put("commodityPrice", String.valueOf(mCommdoityDetail.getCommodityPrice()));//商品价钱
...
//                        startActivity(new Intent(ExternalWebActivity.this, ShoppingCartActivity.class));
                        ...
                        Intent intent = new Intent(NewFairDetailActivity.this, BuyOrderActivityWeb.class);
