...
public class AllGongXuFragment extends BaseFragment implements PullToRefreshView.OnFooterRefreshListener,PullToRefreshView.OnHeaderRefreshListener{
...
//                    Toast.makeText(getContext(), "已加载完", Toast.LENGTH_SHORT).show();
//                    return;
//                }
//                getMyBusinessDistrict(currentPage);
//            }
//        });
        ...
        sosli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getActivity(), GongxuSOS_Activity.class));
            }
        });
    ...
    public void onFooterRefresh(PullToRefreshView view) {
        ...
        if (ab> pageCount) {
            ...
            ToastUtil.showInfo(getContext(), "没有更多数据", Toast.LENGTH_SHORT);
            return;
        }
