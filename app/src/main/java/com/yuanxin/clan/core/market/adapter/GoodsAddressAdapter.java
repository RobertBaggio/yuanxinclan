...
import com.yuanxin.clan.core.market.view.EditGoodsAddressActivity;
 ...
 */
public class GoodsAddressAdapter extends RecyclerView.Adapter<GoodsAddressAdapter.ViewHolder> {
    private Context context;
    private OnItemClickListener mOnItemClickListener;

    private List<PostAddress> entityList;
    private GoodsAddressActivity activity;


    public GoodsAddressAdapter(Context context, List<PostAddress> entities, GoodsAddressActivity activity) {
...
//            holder.itemGoodsAddressAllLayout.setBackgroundResource(R.drawable.border_grey_no);
        ...
        holder.itemGoodsAddressNameEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, EditGoodsAddressActivity.class);
