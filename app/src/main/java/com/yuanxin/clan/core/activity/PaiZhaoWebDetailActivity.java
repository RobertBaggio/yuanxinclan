 ...
 * Author: lgq
 * Date: 2018/1/2 0002 11:51
 */

public class PaiZhaoWebDetailActivity extends BaseActivity {
        ...
        mWebview.addJavascriptInterface(new WebViewJavaScriptFunction() {
            ...
            public void toChat(String toChatUsername) {
                ...
                if (toChatUsername.equals(UserNative.getPhone())){
                    ToastUtil.showInfo(getApplicationContext(), "我发布的！", Toast.LENGTH_SHORT);
                    return;
                }
                Intent intent = new Intent(PaiZhaoWebDetailActivity.this, PersionChatActivity.class);
            ...
            public void onEdit() {
                if (mGongXuEntity.getSupplyDemand().equals("0")){
                    Intent intent = new Intent(PaiZhaoWebDetailActivity.this, OutputGongyActivity.class);
                    intent.putExtra("datas", (Serializable) mGongXuEntity);
                    intent.putExtra("type", "my");
                    startActivity(intent);
                    finish();
                }else {
                    Intent intent = new Intent(PaiZhaoWebDetailActivity.this, OutputXuQiuActivity.class);
                    intent.putExtra("datas", (Serializable) mGongXuEntity);
                    intent.putExtra("type", "my");
                    startActivity(intent);
                    finish();
...
//            window.yxbl_app.lookShoppingCar()  //js调用android源码方法,查看购物车
                startActivity(new Intent(PaiZhaoWebDetailActivity.this, ShoppingCartActivity.class));
            }
...
//                        startActivity(new Intent(ExternalWebActivity.this, ShoppingCartActivity.class));
                        ...
                        Intent intent = new Intent(PaiZhaoWebDetailActivity.this, BuyOrderActivityWeb.class);
