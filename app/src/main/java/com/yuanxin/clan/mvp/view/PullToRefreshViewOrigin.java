...
public class PullToRefreshViewOrigin extends LinearLayout {
    ...
    public PullToRefreshViewOrigin(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public PullToRefreshViewOrigin(Context context) {
        super(context);
        this.context = context;
        init();
    }
    ...
    public interface OnFooterRefreshListener {
        public void onFooterRefresh(PullToRefreshViewOrigin view);
    }
    ...
    public interface OnHeaderRefreshListener {
        public void onHeaderRefresh(PullToRefreshViewOrigin view);
    }
