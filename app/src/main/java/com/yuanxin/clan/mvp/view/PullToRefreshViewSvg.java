...
public class PullToRefreshViewSvg extends LinearLayout {
    ...
    public PullToRefreshViewSvg(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public PullToRefreshViewSvg(Context context) {
        super(context);
        this.context = context;
        init();
    }
...
//        mHeaderProgressBar.setVisibility(View.GONE);
    ...
    public interface OnFooterRefreshListener {
        public void onFooterRefresh(PullToRefreshViewSvg view);
    }
    ...
    public interface OnHeaderRefreshListener {
        public void onHeaderRefresh(PullToRefreshViewSvg view);
    }
